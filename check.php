...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="quizz/disenoQuizz.css">
            ...
            <div class="row">
                <div class="col" id="box">
                    <div class="resultados" id="resultados">
                        ...
                        <p style="text-align: center;" ><a href="menu.php"><button type="button" class="btn btn-dark">Regresar al menú</button></a></p>
                    </div>
                </div>
            </div>
